      ...
      <div className="space-y-4">
        {entities.map((entity, index) => (
          <div
            ...
            className="rounded-xl border border-slate-200 bg-surface p-4 transition hover:border-geo-blue/40"
          >
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-start gap-2">
                <span className="mt-0.5 text-geo-blue">📍</span>
                <div>
            ...
            <div className="mt-4 flex items-center gap-1.5 border-t border-slate-200 pt-3 text-xs font-medium text-slate-400">
